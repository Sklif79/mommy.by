$(document).ready(function () {
    ...
    owl.owlCarousel();
//Go to the next item
    $('.preview-product-slider + .slider-controls .customNextBtn').click(function (e) {
        console.log($(this))
        console.log(e)
        $(this).closest('.slider-controls').prev().trigger('next.owl.carousel');
...
// Go to the previous item
    $('.preview-product-slider + .slider-controls .customPrevBtn').click(function () {
        ...
        $(this).closest('.slider-controls').prev().trigger('prev.owl.carousel');
